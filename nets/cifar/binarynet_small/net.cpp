...
void HeBNN::init(FILE* in_file, bool b_prep)
{
	...
	conv_dep =  10 ;
#if defined(GPU_ENC)
	layer9 = new BinLayer(E_FC_FINAL, conv_dep, E_NO_POOL, E_ACTIVATION_NONE, &params);
#else
	layer9 = new BinLayer(E_FC_FINAL, conv_dep, E_NO_POOL, E_ACTIVATION_NONE, &params, bk) ;
#endif
